      ...
      if (updates.paymentReminder !== undefined) {
        ...
        try {
          ...
          const minimalPayment = new PaymentModel({
            ...
            courseName: course?.name || (student as any).enrolledCourseName || student.program || student.course || 'Unknown Course',
            courseType: course?.type || (student as any).courseType || (student as any).type || '-',
