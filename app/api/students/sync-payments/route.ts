...
// MAINTENANCE ENDPOINT ONLY - EXCEPTION TO READ-ONLY RULE
// This is a one-time data migration/sync endpoint
// Normal operations: Students/Courses = READ ONLY, Payments = READ/WRITE
// This endpoint: Used only for initial data setup or maintenance
