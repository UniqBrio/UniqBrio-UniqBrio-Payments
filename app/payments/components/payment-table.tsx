          ...
          <Table className="min-w-[1500px] relative">
            <TableHeader className="sticky top-0 z-30">
              <TableRow className="bg-gray-100 border-[#9234ea]/20">
                ...
                {isColumnVisible('registration') && <TableHead className="text-sm p-3 font-semibold sticky top-0 z-40 bg-gray-100 border-b-2 border-[#9234ea]/30 shadow-sm whitespace-nowrap min-w-[180px]">Registration</TableHead>}
